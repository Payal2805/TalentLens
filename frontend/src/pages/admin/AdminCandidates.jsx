...
function AdminCandidates() {
  ...
  const statistics = useMemo(() => {
    return {
        ...
        (total, candidate) =>
            total + (candidate.applications_count || 0),
        0
        ),
    };
    }, [candidates]);
  ...
  const toggleCandidateStatus = async (candidate) => {
    try {
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-11 pr-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                />
              ...
              <select
                ...
                className="lg:w-52 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500 bg-white"
              >
                          ...
                          <div className="relative inline-block">
                            ...
                            {actionCandidate?.id === candidate.id && (
                              ...
                              <div className="absolute right-0 top-11 z-30 w-52 bg-white border border-gray-200 rounded-xl shadow-xl py-1">
                                ...
                                <button
                                    type="button"
                                    onClick={() => toggleCandidateStatus(candidate)}
